...
class worldometer {
  ...
  static async trackAll(){
   ...
   static async trackCountry(query){
    ...
    const closedCases = $('body div div div.col-md-8 div div.row div div div.panel-body div div.panel_front div.number-table-main').html()
    const newarr = []
  ...
  let totalDeathPercent = arr[1]
  totalDeathPercent?totalDeathPercent=arr[1]:totalDeathPercent='Data Not Available'
  let object = {
